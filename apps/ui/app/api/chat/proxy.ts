...
async function getChloeAgent() {
  try {
    ...
    const agentModule = await import('@crowd-wisdom/agents-chloe');
    ...
    try {
      require.resolve('@crowd-wisdom/agents-chloe');
      console.log('Package is installed but failed to import');
    } catch (e) {
      console.error('Package @crowd-wisdom/agents-chloe is not installed or not resolvable');
    }
...
1. @crowd-wisdom/agents-chloe package is installed
