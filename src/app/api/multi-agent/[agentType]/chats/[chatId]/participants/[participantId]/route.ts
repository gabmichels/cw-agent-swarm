...
/**
 * GET handler - get a specific participant from a chat
 */
export async function GET(
  ...
  try {
    const { agentType, chatId, participantId } = await params;
    console.log(`API DEBUG: GET multi-agent/${agentType}/chats/${chatId}/participants/${participantId}`);
...
export async function DELETE(
  ...
  try {
    const { agentType, chatId, participantId } = await params;
    console.log(`API DEBUG: DELETE multi-agent/${agentType}/chats/${chatId}/participants/${participantId}`);
...
export async function PATCH(
  ...
  try {
    const { agentType, chatId, participantId } = await params;
    console.log(`API DEBUG: PATCH multi-agent/${agentType}/chats/${chatId}/participants/${participantId}`);
