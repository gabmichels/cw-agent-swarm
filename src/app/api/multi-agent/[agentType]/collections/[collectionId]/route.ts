...
export async function GET(
  ...
  try {
    console.log(`API DEBUG: GET multi-agent/${params.agentType}/collections/${params.collectionId}`);
...
export async function PUT(
  ...
  try {
    console.log(`API DEBUG: PUT multi-agent/${params.agentType}/collections/${params.collectionId}`);
...
export async function DELETE(
  ...
  try {
    console.log(`API DEBUG: DELETE multi-agent/${params.agentType}/collections/${params.collectionId}`);
