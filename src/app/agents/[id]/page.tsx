...
import { Edit, Save, Upload, X, Trash2, MessageSquare, Settings, User, Briefcase, Globe, Share2 } from 'lucide-react';
        ...
        <div className="p-6">
          {activeTab === 'prompts' && (
            <AgentPromptEditor
              ...
              onEditingChange={setIsEditingPrompts}
            />
          )}
