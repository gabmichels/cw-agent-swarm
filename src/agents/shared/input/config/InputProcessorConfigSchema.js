...
exports.InputProcessorPresets = exports.InputProcessorConfigSchema = void 0;
exports.createInputProcessorConfig = createInputProcessorConfig;
/**
 * Schema for input processor configuration
 */
exports.InputProcessorConfigSchema = {
    enabled: {
        type: 'boolean',
        required: true,
        default: true,
 ...
 */
function createInputProcessorConfig(preset, overrides) {
    if (preset === void 0) { preset = 'COMPREHENSIVE'; }
    if (overrides === void 0) { overrides = {}; }
    // Get the preset configuration
    var presetConfig = typeof preset === 'string'
        ? exports.InputProcessorPresets[preset]
        : preset;
    // Merge with base defaults and overrides
    return __assign(__assign({ enabled: true, supportedModalities: ['text'], maxInputSizeBytes: 1048576, preprocessingSteps: ['normalize', 'sanitize', 'trim'], contentFilteringLevel: 'medium', detectLanguage: true, defaultLanguage: 'en', allowStreaming: true, processingTimeoutMs: 5000, maintainHistory: true, maxHistoryItems: 100, sanitization: {
            removeHtml: true,
            removeScripts: true,
            removePii: false,
            customRules: []
