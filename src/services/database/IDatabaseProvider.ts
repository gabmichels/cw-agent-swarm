...
export interface IDatabaseProvider {
  ...
  deleteAgentWorkspacePermissionsByConnection(connectionId: string): Promise<void>;
  ...
  deleteWorkspaceAuditLogsByConnection(connectionId: string): Promise<void>;
  ...
  deleteAgentNotificationsByConnection(connectionId: string): Promise<void>;

  // Workspace Capability Operations
  deleteWorkspaceCapabilitiesByConnection(connectionId: string): Promise<void>;
}
