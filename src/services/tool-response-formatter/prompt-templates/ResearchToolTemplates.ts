...
- Present academic research with methodological precision and scholarly formatting`,
    ...
    successTemplate: `Academic research operation completed:
- Scholarly analysis results and academic methodology execution summary
- Detailed citation analysis and source credibility assessment completed
- Research methodology validation and academic standards compliance verification
- Academic quality assessment and scholarly rigor evaluation results
- Technical recommendations for academic research enhancement and methodology optimization`,

    errorTemplate: `Academic research operation failed:
- Research methodology failure analysis and scholarly impact assessment
- Academic source access limitations and research methodology adjustment requirements
- Alternative scholarly research approaches and academic analysis strategies
- Research integrity preservation and academic methodology continuity measures
- Technical troubleshooting for academic research restoration and scholarly accuracy`,

    partialSuccessTemplate: `Academic research partially completed:
- Successfully analyzed available scholarly sources and academic methodology results
- Outstanding research requirements and academic analysis completeness
- Partial scholarly insights and preliminary academic research findings
- Technical considerations for complete academic research coverage
- Scholarly methodology next steps for comprehensive academic analysis`,
