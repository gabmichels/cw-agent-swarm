...
exports.DEFAULT_INDICES = exports.MESSAGE_TYPES = exports.METADATA_FIELDS = exports.STORAGE_KEYS = exports.DEFAULTS = exports.FILTER_KEYS = exports.COLLECTION_NAMES = void 0;
exports.getCollectionNameWithFallback = getCollectionNameWithFallback;
exports.getDefaultIndicesWithFallback = getDefaultIndicesWithFallback;
/**
 ...
 */
exports.COLLECTION_NAMES = (_a = {},
    _a[types_1.MemoryType.MESSAGE] = 'messages',
    _a[types_1.MemoryType.THOUGHT] = 'thoughts',
    _a[types_1.MemoryType.REFLECTION] = 'reflections',
    _a[types_1.MemoryType.INSIGHT] = 'insights',
    _a[types_1.MemoryType.DOCUMENT] = 'documents',
    _a[types_1.MemoryType.TASK] = 'tasks',
    _a[types_1.MemoryType.MEMORY_EDIT] = 'memory_edits',
    _a[types_1.MemoryType.ANALYSIS] = 'analysis',
    _a);
// Function to get a collection name with fallback to message collection
function getCollectionNameWithFallback(type) {
    return exports.COLLECTION_NAMES[type] || exports.COLLECTION_NAMES[types_1.MemoryType.MESSAGE] || 'messages';
}
/**
...
exports.DEFAULTS = {
    ...
    IMPORTANCE: types_1.ImportanceLevel.MEDIUM, // Default importance level
 ...
 */
exports.DEFAULT_INDICES = (_b = {},
    _b[types_1.MemoryType.MESSAGE] = [
        'timestamp',
        'type',
    ...
    _b[types_1.MemoryType.REFLECTION] = [
        'timestamp',
        'type',
        'metadata.schemaVersion',
        'metadata.processType',
    ...
    _b[types_1.MemoryType.DOCUMENT] = [
        'timestamp',
        'type',
        'metadata.schemaVersion',
        'metadata.source',
    ...
    _b[types_1.MemoryType.MEMORY_EDIT] = [
        'timestamp',
        'type',
        'metadata.schemaVersion',
    ...
    _b[types_1.MemoryType.ANALYSIS] = [
        'timestamp',
        'type',
        'metadata.schemaVersion',
        'metadata.processType',
...
function getDefaultIndicesWithFallback(type) {
    return exports.DEFAULT_INDICES[type] || exports.DEFAULT_INDICES[types_1.MemoryType.MESSAGE] || ['timestamp', 'type'];
}
