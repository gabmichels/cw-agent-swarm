 ...
 */
var DummyCacheManager = /** @class */ (function () {
    function DummyCacheManager() {
    }
    /**
     * Get a value from the cache (always returns undefined)
     */
    DummyCacheManager.prototype.get = function (key) {
     ...
     */
    DummyCacheManager.prototype.set = function (key, value, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
     ...
     */
    DummyCacheManager.prototype.delete = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, true]; // Pretend it succeeded
            });
        });
    };
    /**
     ...
     */
    DummyCacheManager.prototype.clear = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/];
            });
     ...
     */
    DummyCacheManager.prototype.has = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    DummyCacheManager.prototype.invalidateByTag = function (tag) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, 0]; // No keys invalidated
            });
        });
    };
    /**
     ...
     */
    DummyCacheManager.prototype.getStats = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, {
                        size: 0,
     ...
     */
    DummyCacheManager.prototype.getTags = function (key) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
