  ...
  private buildSingleCondition(
    ...
    switch (operator) {
      ...
      case FilterOperator.CONTAINS:
        ...
        // For string contains, Qdrant doesn't support $contains directly
        // Use match with the string value for exact matching instead
        // TODO: Consider using full-text search if needed
        return {
          key: `${key}`,
          match: { value }
        };
